  ...
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        <Link className={styles.link} to="/recursion" data-cy="recursion-link">
          <div className={`${styles.card} ${styles.string}`} />
        </Link>
        <Link className={styles.link} to="/fibonacci" data-cy="fibonacci-link">
          <div className={`${styles.card} ${styles.fibonacci}`} />
        </Link>
        <Link className={styles.link} to="/sorting" data-cy="sorting-link">
          <div className={`${styles.card} ${styles.arr}`} />
        </Link>
        <Link className={styles.link} to="/stack" data-cy="stack-link">
          <div className={`${styles.card} ${styles.stack}`} />
        </Link>
        <Link className={styles.link} to="/queue" data-cy="queue-link">
          <div className={`${styles.card} ${styles.queue}`} />
        </Link>
        <Link className={styles.link} to="/list" data-cy="list-link">
